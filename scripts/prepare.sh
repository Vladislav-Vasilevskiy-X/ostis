...
clone_project https://github.com/VladislavParkhutich/sc-machine.git sc-machine master
clone_project https://github.com/VladislavParkhutich/sc-web.git sc-web master
